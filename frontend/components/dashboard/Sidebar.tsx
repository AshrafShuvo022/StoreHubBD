...
export default function Sidebar({ storeName }: { storeName: string }) {
  ...
  return (
    <aside className="hidden lg:flex w-60 min-h-screen bg-slate-950 flex-col">
      ...
      <div className="px-4 pt-5 pb-4">
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="font-bold text-white text-sm tracking-tight">StoreHubBD</span>
        </div>

        {/* Store pill */}
        <div className="bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5">
          <p className="text-[10px] text-slate-500 uppercase tracking-widest font-semibold mb-0.5">Active Store</p>
          <p className="font-semibold text-slate-200 text-sm truncate capitalize">{storeName}</p>
        </div>
      </div>
