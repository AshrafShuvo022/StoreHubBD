        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-end">
              ...
              <a
                href={`https://wa.me/880${order.customer_phone.replace(/^(\+880|880|0)/, "")}`}
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1 rounded-lg text-xs font-semibold px-2 py-0.5 border"
                style={{ background: "#25D366", color: "#fff", borderColor: "#1fba59" }}
              >
